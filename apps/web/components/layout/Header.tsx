...
export function Header() {
  ...
  return (
    ...
    >
      {/* Espaço para breadcrumbs (será preenchido pelo PageShell) */}
      ...
      <div className="flex items-center gap-3">
        ...
        {/* User Menu */}
        <DropdownMenu>
          <DropdownMenuTrigger className="flex items-center gap-2 px-2 rounded-md hover:bg-accent h-10 outline-none cursor-pointer">
